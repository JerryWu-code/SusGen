...
def evaluate_finqa(model_path, test_data_path, args, output_csv_path):
...
def save_results_to_txt(results, output_txt_path):
...
def main():
    ...
    results = evaluate_finqa(model_path, test_data_path, args, output_csv_path)
