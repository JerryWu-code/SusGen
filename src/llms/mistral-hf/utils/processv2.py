...
def task2(model, tokenizer, device, args, times):
    data = load_json("data/susgen/tcfd_qa/tcfd_qa_v3_clean.json")
    ...
    for _ in range(times):
        for _, v in tqdm(enumerate(data)):
            ...
            append_to_jsonl(temp, "data/susgen/tcfd_qa/cache/diverse_v3_+4.jsonl")
            final.append(temp)
            print("="*50)
            state += 1
...
def main():
    ...
    # concat_jsonl(target_path, output_file="data/susgen/tcfd_qa/tcfd_qa_v3_final.json")
